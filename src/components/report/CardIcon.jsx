...
export default function CardIcon({ name }) {
    ...
    return (
      <span className="relative block size-6 shrink-0 overflow-clip">
        <img
          src={bulbBody}
          alt=""
          className="absolute inset-[12.5%_29.17%_33.33%_20.83%]"
        />
        <img
          src={bulbBase}
          alt=""
          className="absolute bottom-[12.5%] left-[33.33%] right-[41.67%] top-3/4"
        />
      </span>
    );
  }
  ...
  return (
    <span className="flex size-6 shrink-0 items-center justify-center">
      <img src={src} alt="" className="h-[18px] w-auto" />
    </span>
  );
}
