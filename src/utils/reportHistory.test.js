...
test('최근 6개월 절약액과 누적 통계를 기록 기준으로 계산한다', () => {
  const history = [
    record({ price: 50_000 }),
...
test('좋은 소비·절약 소비·보류 기록을 서로 다른 기준으로 분리한다', () => {
  ...
  const pending = record({ choice: 'hold', at: '2026-08-03T12:00:00' })
  const resolved = record({ choice: 'hold', checkin: { resolved: 'buy', satisfied: true }, at: '2026-08-04T12:00:00' })
